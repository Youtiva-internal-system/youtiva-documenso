...
| Domain                   | Used for                                                       |
| ------------------------ | -------------------------------------------------------------- |
| `sign.youtiva.com`      | Transactional email                                            |
| `youtiva.com`      | Transactional email                                            |
...
1. **Check the sender address** — the domain must be `sign.youtiva.com` or `youtiva.com`
2. **Look at the link destination** — hover over any link before clicking; it should point to `sign.youtiva.com`
...
4. **Verify the action yourself** — if in doubt, log in to [sign.youtiva.com](https://sign.youtiva.com) directly (not via the email link) and check whether the document or notification exists there
...
2. Forward the email as an attachment to **support@youtiva.com**
