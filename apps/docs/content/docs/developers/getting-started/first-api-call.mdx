...
| ----------- | -------------------------------------- |
| Production  | `https://sign.youtiva.com/api/v2`     |
| Staging     | `https://stage.sign.youtiva.com/api/v2` |
...
<Tab value="curl">
```bash
curl -X POST "https://sign.youtiva.com/api/v2/envelope/envelope_abc123/distribute" \
  -H "Authorization: YOUR_API_TOKEN" \
...
const response = await fetch(
  `https://sign.youtiva.com/api/v2/envelope/${envelopeId}/distribute`,
  {
    method: 'POST',
    headers: {
      Authorization: 'YOUR_API_TOKEN',
...
BASE_URL="https://sign.youtiva.com/api/v2"
...
- [API Reference](https://sign.youtiva.com/openapi/) - Full endpoint documentation with request/response schemas
