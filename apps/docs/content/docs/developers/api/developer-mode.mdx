...
https://sign.youtiva.com/t/<team-url>/documents/<envelope-id>/legacy_editor?devmode=true
```
...
https://sign.youtiva.com/t/<team-url>/documents/<envelope-id>/edit?step=addFields&devmode=true
```
