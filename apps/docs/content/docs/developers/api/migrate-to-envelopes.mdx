...
Full reference in the [V1 OpenAPI reference](https://sign.youtiva.com/openapi/v1).
...
Full reference in the [V2 OpenAPI reference](https://sign.youtiva.com/openapi).
...
<Accordions>
  ...
  <Accordion title="I need more time or help migrating">
    Reach out to [support@youtiva.com](mailto:support@youtiva.com) with your use case and we will
...
- [V2 OpenAPI reference](https://sign.youtiva.com/openapi): the up-to-date envelope API.
- [V1 OpenAPI reference](https://sign.youtiva.com/openapi/v1): the deprecated V1 API.
- [support@youtiva.com](mailto:support@youtiva.com): migration questions and extensions.
