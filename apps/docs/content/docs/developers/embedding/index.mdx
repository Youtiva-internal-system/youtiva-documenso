...
For example, `https://sign.youtiva.com/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
| `host`                | `string`   | Documenso instance URL. Defaults to `https://sign.youtiva.com`. |
