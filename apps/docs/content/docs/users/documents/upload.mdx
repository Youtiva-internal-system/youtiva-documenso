...
<Callout type="info">
  ...
  [sign.youtiva.com](https://sign.youtiva.com). Self-hosted instances must
...
<Steps>
  <Step>
    ...
    Open your [Documents dashboard](https://sign.youtiva.com/documents).
...
- **Fonts not installed on the server fall back to substitutes.** On sign.youtiva.com, common fonts (Calibri, Arial, Times New Roman, etc.) are installed. On self-hosted instances, font fidelity depends on the operator's setup.
