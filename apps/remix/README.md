...
- Local development: see the [root README](../../README.md) and the [Local Development docs](https://sign.youtiva.com/docs/docs/developers/local-development).
- Self-hosting and deployment: see the [Self-Hosting docs](https://sign.youtiva.com/docs/docs/self-hosting).
