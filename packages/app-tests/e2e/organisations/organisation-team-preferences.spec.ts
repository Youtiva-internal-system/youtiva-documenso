...
test('[ORGANISATIONS]: manage branding preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Brand Website' }).fill('https://sign.youtiva.com');
  ...
  expect(teamSettings.brandingUrl).toEqual('https://sign.youtiva.com');
  ...
  expect(inheritedTeamSettings.brandingUrl).toEqual('https://sign.youtiva.com');
...
test('[ORGANISATIONS]: manage email preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Reply to email' }).fill('organisation@youtiva.com');
  ...
  // Check that the team settings have inherited these values.
  expect(teamSettings.emailReplyTo).toEqual('organisation@youtiva.com');
  ...
  // Check that the team settings now inherit from organisation again.
  expect(inheritedTeamSettings.emailReplyTo).toEqual('organisation@youtiva.com');
  ...
  expect(documentMeta.emailReplyTo).toEqual('organisation@youtiva.com');
